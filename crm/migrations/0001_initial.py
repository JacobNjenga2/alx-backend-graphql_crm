    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(blank=True, max_length=20, null=True, validators=[django.core.validators.RegexValidator(message="Phone must be in format '+1234567890' or '123-456-7890'", regex='^(\\+\\d{1,3}\\d{9,10}|\\d{3}-\\d{3}-\\d{4})$')])),
